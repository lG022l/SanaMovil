...
Sanamóvil es un sistema informático de apoyo a la decisión logística (Software as a Medical Device - Clase I). Su objetivo principal es orientar al público general sobre el nivel de urgencia para buscar atención médica presencial y sugerir el tipo de acción logística adecuada (Traslado, Consulta, Monitoreo).

El proyecto integra modelos de Inteligencia Artificial de forma local mediante MediaPipe y librerías C++ para garantizar un procesamiento rápido y privado directamente en el dispositivo del usuario.

## Características Principales
* **Orientación Logística:** Evaluación interactiva del nivel de urgencia.
* **Inteligencia Artificial Local:** Integración de MediaPipe (GenAI) para análisis de datos médicos.
...
* **Inteligencia Artificial:** MediaPipe Tasks GenAI (v0.10.32)
* **Arquitectura:** MVVM, Lifecycle ViewModel/Runtime Compose
* **NDK/JNI:** CMake (compilación nativa para arquitectura `arm64-v8a`)
